...
用经过200+篇实战验证的爆文结构重新组织，输出可直接排版发布的MD文件。
...
**5a. MD正文**
完整文章的Markdown格式。排版方式：
• 粘贴到 https://ilang.cn/md 预览微信样式后一键复制（该工具为纯前端页面，内容仅在你的浏览器本地处理，不上传到任何服务器）
• 或使用任何其他Markdown编辑器

**5b. 封面图提示词**
根据文章核心观点自动生成I-Lang格式的图像提示词。
用户自行将提示词粘贴到AI出图工具（GPT/Midjourney/DALL-E等）生成封面。
注意：提示词本身不含文章内容，仅描述视觉风格和主题关键词。
...
注意：DeAI是同一AI会话内的文本编辑技能，不涉及外部数据传输。"
